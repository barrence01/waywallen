...
mod tests {
    ...
    fn event_bind_buffers_with_fds() {
        ...
        let sent = Event::BindBuffers {
            ...
            initial_config: crate::wallframe::display::proto::CompositionConfig {
                generation: 1,
                buffer_generation: 1,
                source_rect: crate::wallframe::display::proto::Rect {
                    x: 0.0,
                    y: 0.0,
                    w: 1920.0,
                    h: 1080.0,
                },
                dest_rect: crate::wallframe::display::proto::Rect {
                    x: 0.0,
                    y: 0.0,
                    w: 1920.0,
                    h: 1080.0,
                ...
                transform: 0,
                clear_color: crate::wallframe::display::proto::RgbaColor {
                    r: 0.0,
                    g: 0.0,
                    b: 0.0,
                    a: 1.0,
    ...
    fn back_to_back_frames_parse_independently() {
        ...
        let update = Request::SetDisplayMetrics {
            metrics: crate::wallframe::display::proto::DisplayMetrics {
                width: 800,
                height: 600,
                refresh_mhz: 60_000,
            },
