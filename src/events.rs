...
pub enum GlobalEvent {
    ...
    QrLoginProgress {
        ...
        state: i32,
        qr_image: String,
        display_value: crate::plugin::i18n::LocalizedText,
        error: crate::plugin::i18n::LocalizedText,
        title: crate::plugin::i18n::LocalizedText,
        instruction: crate::plugin::i18n::LocalizedText,
    },
    PlaylistChanged,
    PluginChanged,
    PluginStateChanged,
